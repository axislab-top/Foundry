...
/**
 * 主群 Collaboration Program SSOT：一次交付诉求的完整生命周期。
 */
export class CreateCollaborationPrograms1777500000000 implements MigrationInterface {
  name = 'CreateCollaborationPrograms1777500000000';
